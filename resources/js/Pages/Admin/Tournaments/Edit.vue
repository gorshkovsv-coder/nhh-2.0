    ...
    <div class="flex items-end gap-2">
      ...
      >
        Рэндом
	     ...
	     <Link
          :href="`/admin/tournaments/${tForm.id}/draft`"
          class="px-4 py-2 rounded border border-slate-300 text-sm text-slate-700 hover:bg-slate-50"
        >
          Жеребьёвка команд
        </Link>
...
const props = defineProps({
  ...
  draftTeamIds:   { type: Array, default: () => [] }, // id уже выбранных команд
})
...
// Команды, выбранные для жеребьёвки (чекбоксы)
